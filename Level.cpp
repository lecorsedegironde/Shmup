...
vector<Ennemi*> Level::genLevel()
{
    ...
    vector<Ennemi*> level;
    Ennemi * e1 = new Ennemi(900, 300, Ennemi::W_SOLDIER, Ennemi::H_SOLDIER, Ennemi::SPEED_ENNEMI, 10, idEnnemi, TypeEnnemi::Soldier, 10, 0, 1, 10);
    idEnnemi++;

    Ennemi * e2 = new Ennemi(500, 400, Ennemi::W_SCOUT, Ennemi::H_SCOUT, 0, 20, idEnnemi, TypeEnnemi::Scout, 10, 0, 1, 10);
    idEnnemi++;
